<footer class="footer">
    <div class="container">
      <div class="footer-top">
        <div class="footer-brand">
          ...
          <p class="footer-desc">{{$contacts->smallcaption}}</p>
          <div class="footer-contact-info">
            ...
            <div class="footer-contact-item">
              ...
              <a href="tel:+918026691234">+91 {{$contacts->phonenumber}}</a>
            </div>
            <div class="footer-contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
              <a href="mailto:info@rvdcollege.com">{{$contacts->mail}}</a>
            </div>
          </div>
  ...
  <!-- WHATSAPP -->
  <a href="https://wa.me/91{{$contacts->whatsappnumber}}" class="whatsapp-float" aria-label="Chat on WhatsApp" target="_blank">
